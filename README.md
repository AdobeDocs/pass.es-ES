...
1. Clic **Sugerir una edición** y enviar una solicitud de extracción (PR) con los cambios en la interfaz de usuario de GitHub.
   ...
   Consulte la información general [Guía del colaborador de Adobe Docs](https://experienceleague.adobe.com/docs/contributor/contributor-guide/introduction.html) para obtener más información.
