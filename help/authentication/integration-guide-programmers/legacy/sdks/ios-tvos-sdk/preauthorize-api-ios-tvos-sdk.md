...
>[!IMPORTANT]
>
>La API de autorización **debe** usarse antes de conceder al usuario acceso a los recursos especificados.
...
>[!IMPORTANT]
>
>La lista de posibles errores adicionales recuperados a través de la función de informe de errores mejorada se documenta en [Informes de errores avanzados](/help/authentication/integration-guide-programmers/features-standard/error-reporting/enhanced-error-codes.md).
...
Uno o más recursos tienen denegada una decisión de preautorización y la función de informe de errores mejorada no está habilitada en la configuración de autenticación de Adobe Pass
...
Uno o más recursos tienen denegada una decisión de preautorización y la función de informe de errores mejorada está habilitada en la configuración de autenticación de Adobe Pass
        ...
        "resources": [
            ...
            },
            {
                ...
                "error" : {
                   ...
                   "helpUrl" : "https://experienceleague.adobe.com/docs/primetime/authentication/auth-features/error-reportn/enhanced-error-codes.html?lang=es",
...
Los servicios de autenticación de Adobe Pass experimentaron un error al atender la solicitud de API de preautorización
...
El SDK de autenticación de Adobe Pass produce un error al atender la solicitud de API de preautorización
