...
| CFG5xx | Error | Los servidores de autenticación de Adobe Pass están experimentando errores internos. xx puede ser cualquier número. | - Informar al usuario de la no disponibilidad de la autenticación de Adobe Pass. <br><br> - Omitir autenticación de Adobe Pass. <br> <br> - Informar a Adobe. | Inténtelo más tarde. | Sí | Sí | Sí desde la versión 3.2 |
