...
Para obtener el token de acceso, la aplicación debe seguir los pasos descritos en la [documentación de registro dinámico de cliente](../../rest-api-dcr/apis/dynamic-client-registration-apis-retrieve-access-token.md).
