---
title: Reglas de IA de la API de REST V2
description: Reglas de IA de la API de REST V2
...
# Reglas de IA de la API de REST V2 {#rest-api-v2-ai-rules}

>[!IMPORTANT]
>
> El contenido de esta página se proporciona únicamente con fines informativos. El uso de esta API requiere una licencia actual de Adobe. No se permite el uso no autorizado.

Este documento proporciona a los clientes de Adobe Pass Authentication reglas estructuradas y prácticas recomendadas diseñadas específicamente para el desarrollo asistido por IA de aplicaciones de TVE (TV Everywhere) mediante [API REST V2](rest-api-v2-overview.md).

Siguiendo las reglas de desarrollo de IA descritas en esta guía, los desarrolladores pueden asegurarse de que sus asistentes de codificación de IA ayuden a crear integraciones compatibles, eficientes y mantenibles que se ajusten a los [requisitos obligatorios y prácticas recomendadas](rest-api-v2-checklist.md).

## Reglas de asistentes de codificación {#coding-assistants-rules}

Las reglas proporcionan instrucciones de nivel de sistema a los agentes. Considérelos como un contexto persistente, preferencias o flujos de trabajo. Las reglas de este documento son compatibles con asistentes de codificación populares que funcionan con IA y transforman la [lista de comprobación de la API REST V2](rest-api-v2-checklist.md) en directrices de desarrollo de IA procesables.

Empiece hoy mismo configurando su entorno de desarrollo de IA con nuestro completo conjunto de reglas y experimente las ventajas de la generación de código inteligente y compatible para su integración de la API de REST V2 de autenticación de Adobe Pass. Copie y pegue las reglas siguientes en el archivo de configuración de su entorno de desarrollo, según la herramienta de IA que esté utilizando.
...
- Retrieve configuration for specific service provider: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-configuration-apis/rest-api-v2-configuration-apis-retrieve-configuration-for-specific-service-provider
- Create authentication session: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-create-authentication-session
- Resume authentication session: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-resume-authentication-session
- Retrieve authentication session: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-retrieve-authentication-session-information-using-code
- Perform authentication in user agent: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-perform-authentication-in-user-agent
- Retrieve profiles: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profiles
- Retrieve profile for specific mvpd: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profile-for-specific-mvpd
- Retrieve profile for specific code: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profile-for-specific-code
- Retrieve authorization decisions using specific mvpd: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-decisions-apis/rest-api-v2-decisions-apis-retrieve-authorization-decisions-using-specific-mvpd
- Retrieve preauthorization decisions using specific mvpd: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-decisions-apis/rest-api-v2-decisions-apis-retrieve-preauthorization-decisions-using-specific-mvpd
- Initiate logout for specific mvpd: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-logout-apis/rest-api-v2-logout-apis-initiate-logout-for-specific-mvpd
- Retrieve partner authentication request: https://experienceleague.adobe.com/es/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-partner-single-sign-on-apis/rest-api-v2-partner-single-sign-on-apis-retrieve-partner-authentication-request
