...
Para obtener más información sobre el uso de ECID en la autenticación de Adobe Pass, consulte [Uso del Experience Cloud ID en la autenticación de Adobe Pass](/help/authentication/integration-guide-programmers/features-standard/analytics/exp-cloud-id-authn.md).
