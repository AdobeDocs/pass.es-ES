            ...
            <tr>
               ...
               <td>
                  ...
                  Los valores posibles son:<ul>
                    <li><b>mvpd (por ejemplo, Spectrum, Cablevision, etc.)</b><br/>El perfil se creó como resultado de: autenticación básica, inicio de sesión único con identidad de plataforma o inicio de sesión único con token de servicio.</li>
...
### &#x200B;1. Recuperar perfiles obtenidos mediante autenticación básica
...
### &#x200B;2. Recupere perfiles obtenidos mediante autenticación básica o inicio de sesión único mediante el método de token de servicio
...
### &#x200B;3. Recupere perfiles obtenidos mediante autenticación básica o inicio de sesión único mediante el método de identidad de Platform
