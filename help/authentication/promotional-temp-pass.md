...
El pase temporal promocional se basa en la función [Pase temporal](/help/authentication/temp-pass.md), lo que significa que incluye toda la funcionalidad Pase temporal.
