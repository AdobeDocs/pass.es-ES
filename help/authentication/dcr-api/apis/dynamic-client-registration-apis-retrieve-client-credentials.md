...
<table style="table-layout:auto">
   ...
   <tr>
      ...
      <td>
            La declaración de software asociada con la aplicación registrada creada y descargada desde <a href="https://console.auth.adobe.com/">Adobe Pass TVE Dashboard</a>.
            <br/><br/>
   ...
   <tr>
      ...
      <td>URI de redireccionamiento asociado con la ubicación a la que va el agente de usuario cuando se completa el flujo de autenticación.</td>
      <td>opcional</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td>
         ...
         <table style="table-layout:auto">
            ...
            <tr>
               <td style="background-color: #DEEBFF;">ámbitos</td>
