...
Para obtener una lista de las MVPD que admiten la autorización de comprobación preliminar, consulte la página [Autorización de comprobación preliminar de MVPD](/help/authentication/mvpd-preflight-authz.md#preflight_support_list).
