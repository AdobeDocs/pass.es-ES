...
+ Guía de integración del programador {#programmer-integration-guide}
   ...
   + API DE REST V2 {#rest-api-v2}
      ...
      + [Preguntas frecuentes sobre la API de REST V2](./rest-api-v2/rest-api-v2-faqs.md)
      ...
      + Libros de cocina {#rest-api-v2-cookbooks}
         + [Guía de API de REST V2 (de cliente a servidor)](rest-api-v2/cookbooks/rest-api-v2-cookbook-client-server.md)
         + [Guía de API de REST V2 (servidor a servidor)](rest-api-v2/cookbooks/rest-api-v2-cookbook-server-server.md)
   ...
   + SDK de AccessEnabler {#accessenabler-sdk}
      + SDK para JavaScript {#javascriptsdk}
         ...
         + API de JavaScript {#javascript-sdk-api}
            + [Preautorizar](preauthorize-api-javascript-sdk.md)
      + SDK {#ios-sdk} de iOS/tvOS
         ...
         + API de iOS/tvOS {#ios-tvos-sdk-api}
            + [Preautorizar](preauthorize-api-ios-tvos-sdk.md)
...
+ Funciones de autenticación de Adobe Pass {#auth-features}
   ...
   + Metadatos de usuario {#user-metadat}
      ...
      + [Certificado de metadatos de usuario para cifrado](user-metadata-certificate.md)
...
+ Notas de la versión {#release-notes}
   + [Notas de la versión de Adobe Pass Authentication 3.0.3](auth-rn-303.md)
   + [Notas de la versión de Adobe Pass Authentication 3.0](auth-rn-300.md)
...
+ [Guía del usuario del Tablero de TVE](tve-dashboard/old-tve-dashboard/tve-dashboard-user-guide.md)
+ Nueva guía de usuario del panel de TVE {#user-guide}
   + [Resumen del panel de TVE](/help/authentication/tve-dashboard/new-tve-dashboard/tve-dashboard-overview.md)
