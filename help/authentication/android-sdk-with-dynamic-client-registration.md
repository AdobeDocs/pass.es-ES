...
Android SDK v3.0+ utilizará el procedimiento de registro de cliente dinámico como se define en [Información general sobre el registro de cliente dinámico](./dcr-api/dynamic-client-registration-overview.md).
