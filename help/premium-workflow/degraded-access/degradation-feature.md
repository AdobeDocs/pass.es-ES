...
Esta característica está diseñada para utilizarse junto con una [API de supervisión de uso](/help/premium-workflow/esm/entitlement-service-monitoring-overview.md) y basada en los acuerdos previos con MVPD, la autenticación de Adobe Pass ofrece una potente herramienta para equilibrar la experiencia del usuario, la fiabilidad y el control operativo durante los momentos críticos.
