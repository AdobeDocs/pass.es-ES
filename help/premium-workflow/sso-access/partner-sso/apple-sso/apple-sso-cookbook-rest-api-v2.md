...
> <br/>
>
> * La aplicación de streaming ha completado los [requisitos previos de incorporación](/help/premium-workflow/sso-access/partner-sso/apple-sso/apple-sso-overview.md#apple-sso-prerequisites-programmer) que se aplican a un programador y que son necesarios para habilitar la experiencia del usuario de inicio de sesión único de Apple.
